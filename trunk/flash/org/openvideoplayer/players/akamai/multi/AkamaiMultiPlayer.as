package org.openvideoplayer.players.akamai.multi{
	...
	import org.openvideoplayer.players.akamai.multi.view.*;
		...
		*/
		...
		private function init(flashvars:Object,width:Number,height:Number):void {
			...
			_model.addEventListener(_model.EVENT_RESIZE, addMultiBitrateMenuOptionsHandler);
		...
		private function addContextMenu():void {
			...
			var idItem:ContextMenuItem = new ContextMenuItem("Akamai Multi Player v1.0.0",true);
		...
		private function addMultiBitrateMenuOptionsHandler(e:Event):void {
